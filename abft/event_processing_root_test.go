...
func TestSeedClassicRoots(t *testing.T) {
...
func TestSeedRandomRoots(t *testing.T) {
	// generated by codegen4SeedRandomRoot()
	testSpecialNamedRoots(t, `
 A1.01    
 ║         ║        
 ╠════════ B1.01    
...
func testSpecialNamedRoots(t *testing.T, scheme string) {
	...
	// init abft
	lch, _, input := FakeSeed(nodes, nil)
...
/*
// codegen4SeedRandomRoot is for test data generation.
func codegen4SeedRandomRoot() {
	nodes, events := inter.GenEventsByNode(4, 20, 2, nil)

	p, _, input := FakeSeed(nodes)
	// process events
	config := inter.Events{}
